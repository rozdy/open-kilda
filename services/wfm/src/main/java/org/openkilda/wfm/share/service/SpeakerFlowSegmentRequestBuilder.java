...
public class SpeakerFlowSegmentRequestBuilder implements FlowCommandBuilder {
    ...
    private List<FlowSegmentRequestProxiedFactory> makeCommonRequest(
        ...
        if (doEnter && isRequiredSwitch(ingressEndpoint.getSwitchId())) {
        ...
        if (doExit && isRequiredSwitch(egressEndpoint.getSwitchId())) {
    ...
    private List<FlowSegmentRequestProxiedFactory> makeTransitRequests(
    ...
    private FlowSegmentRequestProxiedFactory makeOneSwitchFlowRequest(
            FlowPath path, CommandContext context, FlowEndpoint ingressEndpoint, FlowEndpoint egressEndpoint) {
    ...
    private FlowSegmentRequestProxiedFactory makeIngressSegmentRequest(
        ...
        return IngressFlowSegmentRequestFactory.builder()
                ...
                .endpoint(endpoint)
                .meterConfig(getMeterConfig(path))
                .egressSwitchId(egressEndpoint.getSwitchId())
                .islPort(islPort)
                .encapsulation(encapsulation)
                .build().makeProxyFactory();
    }

    private FlowSegmentRequestProxiedFactory makeTransitSegmentRequest(
    ...
    private FlowSegmentRequestProxiedFactory makeEgressSegmentRequest(
