...
public class ValidateFlowAction extends
        NbTrackableAction<FlowDeleteFsm, FlowDeleteFsm.State, FlowDeleteFsm.Event, FlowDeleteContext> {
    ...
    @Override
    protected Optional<Message> perform(FlowDeleteFsm.State from, FlowDeleteFsm.State to,
